  ...
  register(null, {
    ...
    },
    {
        ...
        post(req, res) {
          ...
          todoWorkEmailClient.submitWorkEmail(sendLink, { body: { email } }, function(error, result, body) {
      ...
      },
      {
        ...
        post(req, res) {
          ...
          todoWorkEmailClient.optOut(optOutWorkEmailLink, { body: {optedOutVerificationOption: req.body.reason}}, function(error, result, body) {
            const serviceError = errorHandler.captureServiceError(error, result, body);
            if (serviceError) {
              const statusCode = (serviceError.statusCode === 200) ? 500 : serviceError.statusCode;
